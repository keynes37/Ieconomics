...
# Datos
Periodo<-c(2022, 2023, 2024, 2025, 2026)
...
<font size="+4">$$\text{Costo}_{2022}= 470 \times (40) + 510 \times (25)= 31.550 $$</font>
...
El .hi[año base] viene a ser el año 2025

---
# Como se mide la inflación?

```{r, cost4, echo=FALSE, message=FALSE, warning=FALSE}
df1%>%
  mutate(Costo=BienX*40+BienY*25)%>%
  mutate(IPC=(Costo/32600)*100)%>%
...
<img src="Images/P4.png" width="480" />
]

.pull.right[
<font size="+5">.hi-turquoise[PAASCHE]</font>
<img src="Images/P3.png" width="480" />
]
...
<img src="Images/P2.png" width="880"/>
<br>
Fuente: Lora y Prada (2013)
