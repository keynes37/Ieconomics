...
+ .orange[PEI]: Población Económicamente inactiva. 
...
Car <- c("TGP", "TO", "TD")
S_2025 <- c(64.1, 56.7, 11.6)
S_2026 <- c(63.6, 56.7, 10.9)
data <- data.frame(Car, S_2025, S_2026)
...
ggplot(data_long, aes(x=Car, y=Valor, fill=Periodo))+
  ...
  labs(x = "Indicadores", y = "Porcentaje (%)", title = "Comparación de Indicadores de ML 2025 vs 2026",
       subtitle = "DANE Febrero 2026") +
