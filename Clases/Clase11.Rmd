...
> Esta tasa nos indica la carga que tiene la oferta laboral en el país. Una tasa mayor nos indica 
...
Car <- c("TGP", "TO", "TD")
A_2022 <- c(63.5, 55.8, 12.1)
A_2023 <- c(64.3, 57.9, 10)
...
ggplot(data_long, aes(x=Car, y=Valor, fill=Periodo))+
  ...
  labs(x = "Indicadores", y = "Porcentaje (%)", title = "Comparación de Indicadores del Mercado Marzo 2022 vs. 2023",
       subtitle = "DANE Abril 2023") +
