...
data <- data.frame(
  year = c(2010:2021),
  value = c(30.35, 30.23, 29.09, 30, 31.26, 31.28, 29.9, 29.32, 34.66, 32.88, 33.56, 34.51)
)
...
<font size="+3">350 Billones de pesos</font> <br>
<font size="+2">.hi-orange[Aprobado por el congreso para 2023]</font> 
